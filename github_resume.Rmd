...
subtitle: "Veni-funded developmental data scientist, using machine learning to predict teenagers' emotional problems"
date: "11/30/2019"
...
[According to Google Scholar, my work has been cited `r scholar_profile$total_cites` times (G-index: `r calculate_g(scholar_pubs)`, H-index: `r scholar_profile$h_index`, i10-index: `r scholar_profile$i10_index`).](https://scholar.google.com/citations?user=ub59lUMAAAAJ)
